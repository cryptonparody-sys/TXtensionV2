  ...
  providerCatalog: {
    ...
    openrouter: {
      ...
      models: {
        ...
        'x-ai/grok-4-fast': { name: 'Grok 4 Fast', tier: 'pro', context: 131072, speed: 'very-fast', endpoint: 'https://openrouter.ai/api/v1' },
        'google/gemini-2.0-flash-001': { name: 'Gemini 2.0 Flash', tier: 'pro', context: 1048576, speed: 'very-fast', endpoint: 'https://openrouter.ai/api/v1' }
      }
    },
    groq: {
      id: 'groq',
